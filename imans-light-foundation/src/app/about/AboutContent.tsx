...
const t = {
  en: {
    ...
    team: [
      { name: 'Mari C. Rodriguez', role: 'Founder & President', image: '/media/56e6ee_c8a42446ccc74e71817a9116052f4ce2~mv2.jpg', bio: 'Driven by profound personal loss, Mari transformed her family’s tragedy into an uncompromising foundation that reaches tens of thousands. Her work honors her daughter while fighting to ensure no other mother has to endure the devastation of the fentanyl crisis.' },
      { name: 'Brianna A. Rodriquez', role: 'Vice President', image: '/media/56e6ee_af44b0afacc84026a7d798066e207ef3~mv2.png', bio: 'Iman\'s loving sister. Brianna carries forward Iman’s spirit by directly impacting youth outreach, standing as a pillar of strength, resilience, and compassion for her community.' },
      { name: 'Maria E. Liriano', role: 'Treasurer', image: '/media/56e6ee_3ddb5580bfcd4f2f85790a4e10b0ef56~mv2.jpg', bio: 'A successful entrepreneur for over 30 years with a background in Real Estate and Escrow. Maria manages our foundation’s finances to ensure every single dollar is effectively utilized to support our educational and therapeutic initiatives.' },
      { name: 'Mercy M. Preciado', role: 'Outreach Community Chair', image: '/media/56e6ee_aa30d37cd6ce4cddb9cee9bfd4c40832~mv2.jpeg', bio: 'A Spiritual Counselor with a Master’s in Psychology. Mercy connects individuals and families with life-changing mental health services, blending professional expertise with deep spiritual guidance.' },
      { name: 'Dunia Cuneo', role: 'Volunteer Director', image: '/media/56e6ee_fe5c234f71af45758073f116758dc4b1~mv2.jpeg', bio: 'A dedicated educator and HR professional with over 25 years of experience. Dunia leverages her MBA and acumen to foster inclusive cultures, mentoring emerging leaders to drive systemic change through community advocacy.' },
      { name: 'Brittany DeMeo', role: 'Recording Secretary', image: '/media/56e6ee_3c8481b926504a1dae34abe7d0fd3dde~mv2.jpeg', bio: 'Joining the foundation after witnessing the devastating regional impacts of fentanyl, Brittany ensures that our operational structure remains efficient, organized, and perfectly clear so our resources hit the frontlines immediately.' },
      { name: 'Libby L. Calero', role: 'PR & Sponsor Development', image: '/media/56e6ee_37bc5c9d971949858e3cd5393e414ae6~mv2.jpg).jpg', bio: 'With over 25 years in hospitality and PR (working alongside DJ Irie and Jamie Foxx), Libby uses her vast network to bring massive visibility and crucial sponsorships to the foundation’s life-saving mission.' },
      { name: 'Victor H. Jinete', role: 'Audio Visual Director', image: '/media/56e6ee_1857a150774e4beb9114d4788de004a5~mv2.jpeg', bio: 'Known as "Vic The Kid", this rising Latin music artist uses his massive platform to produce engaging content for the foundation, demonstrating to youth that success and joy do not require lethal substances.' },
      { name: 'Naylin Rizo, LMHC', role: 'Psychology Advisor', image: '/media/56e6ee_35c37897108948f48e30e3d1ff4434c9~mv2.jpg', bio: 'A Licensed Mental Health Counselor with 14+ years guiding teens and adults through trauma and addiction. She ensures our mental wellness programs are clinically sound and maximally effective.' },
      ...
      { name: 'Nicolas S. Nobrega', role: 'IT Intern', image: '/media/56e6ee_e765024d488a45ffad6cb38cac0d5d78~mv2.jpeg', bio: 'A passionate Cybersecurity student at FIU, Nicolas handles the foundation’s digital infrastructure, ensuring our lifesaving resources and data remain accessible, secure, and easily reachable.' },
    ],
  ...
  es: {
    ...
    team: [
      { name: 'Mari C. Rodriguez', role: 'Fundadora y Presidenta', image: '/media/56e6ee_c8a42446ccc74e71817a9116052f4ce2~mv2.jpg', bio: 'Impulsada por una profunda pérdida personal, Mari transformó la tragedia de su familia en una base intransigente que llega a decenas de miles.' },
      { name: 'Brianna A. Rodriquez', role: 'Vicepresidenta', image: '/media/56e6ee_af44b0afacc84026a7d798066e207ef3~mv2.png', bio: 'La amorosa hermana de Iman. Brianna lleva adelante el espíritu de Iman impactando directamente a los jóvenes como un pilar de fortaleza.' },
      { name: 'Maria E. Liriano', role: 'Tesorera', image: '/media/56e6ee_3ddb5580bfcd4f2f85790a4e10b0ef56~mv2.jpg', bio: 'Con experiencia en Bienes Raíces y Fideicomiso. Maria administra las finanzas para garantizar que cada dólar se utilice para apoyar nuestras iniciativas.' },
      { name: 'Mercy M. Preciado', role: 'Presidenta Comunitaria', image: '/media/56e6ee_aa30d37cd6ce4cddb9cee9bfd4c40832~mv2.jpeg', bio: 'Mercy conecta a las familias con servicios de salud mental que cambian sus vidas, combinando la experiencia profesional con la guía espiritual.' },
      { name: 'Dunia Cuneo', role: 'Directora de Voluntarios', image: '/media/56e6ee_fe5c234f71af45758073f116758dc4b1~mv2.jpeg', bio: 'Dunia aprovecha su MBA y perspicacia de Recursos Humanos para cambiar sistemas educativos en apoyo hacia la comunidad.' },
      { name: 'Brittany DeMeo', role: 'Secretaria', image: '/media/56e6ee_3c8481b926504a1dae34abe7d0fd3dde~mv2.jpeg', bio: 'Garantiza que nuestra estructura operativa se mantenga eficiente, organizada y perfectamente clara en nuestras misiones diarias.' },
      { name: 'Libby L. Calero', role: 'Relaciones Públicas', image: '/media/56e6ee_37bc5c9d971949858e3cd5393e414ae6~mv2.jpg).jpg', bio: 'Utiliza su vasta red (DJ Irie, Jamie Foxx) para dar visibilidad masiva y patrocinios cruciales a la misión de la fundación.' },
      { name: 'Victor H. Jinete', role: 'Director Audiovisual', image: '/media/56e6ee_1857a150774e4beb9114d4788de004a5~mv2.jpeg', bio: 'El artista de música latina ("Vic The Kid") utiliza su plataforma para demostrar a los jóvenes que el éxito no requieren sustancias letales.' },
      { name: 'Naylin Rizo, LMHC', role: 'Asesora Psicológica', image: '/media/56e6ee_35c37897108948f48e30e3d1ff4434c9~mv2.jpg', bio: 'Asesora especializada en traumas y adicciones, garantiza que nuestros programas enfocados en el bienestar mental sean sumamente efectivos.' },
      ...
      { name: 'Nicolas S. Nobrega', role: 'Pasante de TI', image: '/media/56e6ee_e765024d488a45ffad6cb38cac0d5d78~mv2.jpeg', bio: 'Nico maneja nuestra infraestructura cibernética para que los recursos siempre estén totalmente seguros y accesibles para todos.' },
    ],
