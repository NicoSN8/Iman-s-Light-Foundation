...
const t = {
  en: {
    ...
    team: [
      ...
      { name: 'Libby L. Calero', role: 'PR & Sponsor Development', image: '/media/56e6ee_37bc5c9d971949858e3cd5393e414ae6~mv2.jpg', bio: 'With over 25 years in hospitality and PR (working alongside DJ Irie and Jamie Foxx), Libby uses her vast network to bring massive visibility and crucial sponsorships to the foundation’s life-saving mission.' },
  ...
  es: {
    ...
    team: [
      ...
      { name: 'Libby L. Calero', role: 'Relaciones Públicas', image: '/media/56e6ee_37bc5c9d971949858e3cd5393e414ae6~mv2.jpg', bio: 'Utiliza su vasta red (DJ Irie, Jamie Foxx) para dar visibilidad masiva y patrocinios cruciales a la misión de la fundación.' },
