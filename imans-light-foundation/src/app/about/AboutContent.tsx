...
const t = {
  en: {
    ...
    team: [
      ...
      { name: 'Nicolas Su Nobrega', role: 'Director of Technology & Web Development', image: '/media/nicolas-su-nobrega.jpeg', bio: "Originally from Peru and a cybersecurity graduate, Nicolas designed and built the foundation's website from the ground up, including the donation and ticketing system, the events database, and the admin dashboard the team uses every day. He's worked directly with the Foundation's leadership since 2025 to keep the site accurate, secure, and running." },
    ],
    ...
    awards: [
      ...
      { year: '2025', title: 'Certificate of Appreciation for Education, Awareness & Prevention', org: 'U.S. DEA Miami Laboratory, presented by Director Mirlane Germain Titus and Supervisory Chemist April Taylor' },
  ...
  es: {
    ...
    team: [
      ...
      { name: 'Nicolas Su Nobrega', role: 'Director de Tecnología y Desarrollo Web', image: '/media/nicolas-su-nobrega.jpeg', bio: 'Originario de Perú y graduado en ciberseguridad, Nicolas diseñó y construyó desde cero el sitio web de la fundación, incluyendo el sistema de donaciones y venta de boletos, la base de datos de eventos y el panel administrativo que el equipo usa a diario. Trabaja directamente con el liderazgo de la Fundación desde 2025 para mantener el sitio preciso, seguro y en funcionamiento.' },
    ],
    ...
    awards: [
      ...
      { year: '2025', title: 'Certificado de Apreciación por Educación, Concientización y Prevención', org: 'Laboratorio de la DEA de Miami, entregado por la Directora Mirlane Germain Titus y la Química Supervisora April Taylor' },
